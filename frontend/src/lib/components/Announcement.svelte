...
{#if show}
  <div class="fixed inset-x-0 bottom-0 p-4" transition:fly={{ y: '0', duration: 300 }}>
    <div
      class="relative flex items-center justify-between gap-4 rounded-lg bg-indigo-600 px-4 py-3 text-white shadow-lg"
    >
      <p class="text-sm font-medium">
        Loving SoundFlow??
        <a href="https://sigaa.ufrn.br/" target="_blank" class="inline-block underline">Give us a 10 for our work!</a>
      </p>
